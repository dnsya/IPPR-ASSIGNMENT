function CottonGloveDefectDetectionGUI
    ...
    axesMain = axes('Parent', fig, ...
                    ...
                    'XTick', [], 'YTick', []);
    title(axesMain, 'Image Display', 'FontSize', 14, 'FontWeight', 'bold');
    ...
    function loadImage(~, ~)
        ...
        if filename ~= 0
            ...
            axes(axesMain);
            imshow(img);
            title(axesMain, 'Original Image', 'FontSize', 14, 'FontWeight', 'bold');
    ...
    function detectLooseYarn(~, ~)
        ...
        axes(axesMain);
        imshow(resultImg);
        title(axesMain, 'Loose Yarn Detection Results', 'FontSize', 14, 'FontWeight', 'bold');
    ...
    function detectDust(~, ~)
        ...
        axes(axesMain);
        imshow(resultImg);
        title(axesMain, 'Dust Particle Detection Results', 'FontSize', 14, 'FontWeight', 'bold');
    ...
    function detectCuffCuts(~, ~)
        ...
        axes(axesMain);
        imshow(resultImg);
        title(axesMain, 'Cuff Cuts Detection Results', 'FontSize', 14, 'FontWeight', 'bold');
