function CottonGloveDefectDetectionGUI
    ...
    function clearImage(~, ~)
        ...
        set(txtResults, 'String', 'Results will appear here', 'ForegroundColor', theme.fg);
        set(txtStatus,  'String', 'Status: Image cleared. Load a new image to begin.', 'ForegroundColor', theme.muted);
        set(btnDetectDust,  'Enable', 'off');
        set(btnDetectStain, 'Enable', 'off');
        set(btnDetectCuts,  'Enable', 'off');
        set(btnDetectAll,   'Enable', 'off');
